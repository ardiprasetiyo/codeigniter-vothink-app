					...
					<div class="card-content" style="padding: 0; min-height: 600px;">
						<div class="columns" style="margin-left: 0px;">
							<div class="column is-6" style="position: absolute; height: 105%; padding: 40px;">
								<img src="<?= base_url() ?>data/illustration/admin_illustration.svg" style="margin-top: 60px;">
								<h1 class="title is-5 has-text-centered" style="font-weight: 100;"><br>Admin Pages</h1>
							</div>
							<div class="column is-6" style="position: absolute; overflow-y: auto; height: 105%; right: 0px;background-color: #4285f4; box-shadow: -1px 0px 12px 0px #4a80d885; padding: 40px;">
								...
								<form method="POST" action="<?= site_url() ?>/login/admin/verifikasi/">
									<div class="columns">
										<div class="column is-10 is-offset-1">
											<input type="text" name="vt-username" required class="input title is-5 has-text-centered" style="height: 50px; border-radius: 30px;" placeholder="Masukan username">

											<input type="password" name="vt-password" required class="input title is-5 has-text-centered" style="height: 50px; border-radius: 30px;" placeholder="Masukan Password">
										</div>
									</div>
									<div class="columns">
